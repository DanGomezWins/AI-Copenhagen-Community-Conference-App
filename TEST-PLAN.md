...
**Round 2 done:** all sections attempted. Almost everything passes.
**Focus now:** the 5 rows below, then the untested leftovers.
...
### Still untested from earlier rounds

**4.8** (back from a profile to Program) · **5.13** (open a profile) ·
**5.15** (a speaker's sessions listed) · **7.6, 7.7, 7.8** (blocked by VAPID) ·
**7.9, 7.19** · **section 8** (Android, optional)
...
`✅` passed · `🔧` fixed — **retest** · `🔁` skipped — **retest** · blank = not tested
